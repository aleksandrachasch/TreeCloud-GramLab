...
public class NeighborJoining {
	...
	public String computeNJTree(ArrayList<ArrayList<Double>> distancematrix , ArrayList<String> taxanames){
		...
		//for(ArrayList<Double> r: qmatrix){
		...
		//System.out.println(newtaxanames);
		...
		//for(ArrayList<Double> r : newdistancematrix){
			//System.out.println(r);
		//}
		/*
	...
	public void saveToFile(String newick, String path) throws IOException{
